...
import SidebarHousehold from '@/components/sidebar/sidebar-household';
...
export default function Sidebar() {
	...
	useEffect(() => {
		...
		const handleSidebarMinifyFloatMenu = (event: MouseEvent) => {
			...
			const sidebarX = (document.documentElement.getAttribute('dir') === 'rtl') ? window.innerWidth - sidebarRect.left : sidebarRect.left + sidebarWidth;
			...
			floatSubmenu.style.insetInlineStart = `${sidebarX}px`;
